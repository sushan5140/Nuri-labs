...
export default function NuriAtlas(){
 ...
 <div className="na-ticker"><span>LEARN SOMETHING NEW ✳ FIND YOUR PEOPLE ✳ GET LOST IN A STORY ✳ BUILD YOUR NEXT CHAPTER ✳ LEARN SOMETHING NEW ✳ FIND YOUR PEOPLE ✳ GET LOST IN A STORY ✳ BUILD YOUR NEXT CHAPTER ✳ </span></div><Trail onPick={openWorld}/><StoryFlow onOpen={openWorld} onExplore={()=>scroll('universe')}/></main>
