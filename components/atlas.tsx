...
export default function NuriAtlas(){
 ...
 <div className="na-ticker"><span>LEARN SOMETHING NEW ✳ FIND YOUR PEOPLE ✳ GET LOST IN A STORY ✳ BUILD YOUR NEXT CHAPTER ✳ LEARN SOMETHING NEW ✳ FIND YOUR PEOPLE ✳ GET LOST IN A STORY ✳ BUILD YOUR NEXT CHAPTER ✳ </span></div><Trail onPick={openWorld}/><section className="na-finale"><div className="na-wrap na-finale-grid"><div><span className="na-kicker">02 / WHY NURI EXISTS</span><h2>Built for people<br/>going <em>somewhere.</em></h2><p>NURI Labs is an independent student-led educational technology initiative. We build experiences that make language and learning feel a little closer.</p><button className="na-button" type="button" onClick={()=>navigate('hub')}>Explore the NURI hub <ArrowUpRight size={18}/></button></div><div className="na-finale-art" aria-hidden="true"><span>n</span><i>✳</i><b>you belong<br/>in the story</b></div></div></section></main>
